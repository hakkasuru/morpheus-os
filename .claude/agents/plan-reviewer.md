...
model: claude-opus-4-8 # pinned to Opus 4.8 specifically (not the "opus" alias, which floats to latest). Pinned deliberately: the score can bypass a human gate — cheap task, high stakes; avoid small models here
---
