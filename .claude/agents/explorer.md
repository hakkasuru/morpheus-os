...
model: sonnet # resolves to the latest Sonnet (Claude Sonnet 5 today) — exploration is high-volume and read-only; a mid-tier model is the right default
---

<!-- Full native definition. Canonical spec: workflow/explorer.md — if you
     change one, change both (and .github/agents/explorer.agent.md). -->
