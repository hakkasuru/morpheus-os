...
# default model. Use the edit tool ONLY to write the review report.
---

<!-- Full native definition for GitHub Copilot (CLI, coding agent, IDEs).
     Canonical spec: workflow/diff-reviewer.md — if you change one, change
     both (and .claude/agents/diff-reviewer.md). -->
